      ...
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <Typography variant="h5" className="mb-6">
            <img src="https://vecros.com/static/media/vecros_logo_exp4.e0d68dc5e8c45587ddfb.png" className="mt-2 w-72 h-20" />
          </Typography>
        ...
        <div className="mt-4 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">Vecros</a>. All
            Rights Reserved.
          </Typography>
